...
const uint8_t gatt_database[] =
{
    ...
    PRIMARY_SERVICE_UUID16 (HDLS_HIDS, __UUID_SERVICE_HUMAN_INTERFACE_DEVICE),
        ...
        CHARACTERISTIC_UUID16_WRITABLE (HDLC_HIDS_HID_CONTROL_POINT, HDLC_HIDS_HID_CONTROL_POINT_VALUE, __UUID_CHARACTERISTIC_HID_CONTROL_POINT, GATTDB_CHAR_PROP_WRITE_NO_RESPONSE, GATTDB_PERM_WRITE_REQ | GATTDB_PERM_WRITE_CMD),
        ...
        CHARACTERISTIC_UUID16 (HDLC_HIDS_KBD_IN_REPORT, HDLC_HIDS_KBD_IN_REPORT_VALUE, __UUID_CHARACTERISTIC_REPORT, GATTDB_CHAR_PROP_READ | GATTDB_CHAR_PROP_NOTIFY, GATTDB_PERM_READABLE),
            /* Descriptor: Client Characteristic Configuration */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_HIDS_KBD_IN_REPORT_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, GATTDB_PERM_READABLE | GATTDB_PERM_WRITE_REQ | GATTDB_PERM_WRITE_CMD),
            /* Descriptor: Report Reference */
        ...
        CHARACTERISTIC_UUID16 (HDLC_HIDS_VOICE_IN_REPORT, HDLC_HIDS_VOICE_IN_REPORT_VALUE, __UUID_CHARACTERISTIC_REPORT, GATTDB_CHAR_PROP_READ | GATTDB_CHAR_PROP_NOTIFY, GATTDB_PERM_READABLE),
            /* Descriptor: Client Characteristic Configuration */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_HIDS_VOICE_IN_REPORT_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, GATTDB_PERM_READABLE | GATTDB_PERM_WRITE_REQ | GATTDB_PERM_WRITE_CMD),
            /* Descriptor: Report Reference */
            CHAR_DESCRIPTOR_UUID16 (HDLD_HIDS_VOICE_IN_REPORT_REPORT_REFERENCE, __UUID_DESCRIPTOR_REPORT_REFERENCE, GATTDB_PERM_READABLE),
        /* Characteristic: voice_ctl_in_report */
        CHARACTERISTIC_UUID16 (HDLC_HIDS_VOICE_CTL_IN_REPORT, HDLC_HIDS_VOICE_CTL_IN_REPORT_VALUE, __UUID_CHARACTERISTIC_REPORT, GATTDB_CHAR_PROP_READ | GATTDB_CHAR_PROP_NOTIFY, GATTDB_PERM_READABLE),
            /* Descriptor: Client Characteristic Configuration */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_HIDS_VOICE_CTL_IN_REPORT_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, GATTDB_PERM_READABLE | GATTDB_PERM_WRITE_REQ | GATTDB_PERM_WRITE_CMD),
            /* Descriptor: Report Reference */
            CHAR_DESCRIPTOR_UUID16 (HDLD_HIDS_VOICE_CTL_IN_REPORT_REPORT_REFERENCE, __UUID_DESCRIPTOR_REPORT_REFERENCE, GATTDB_PERM_READABLE),
        /* Characteristic: voice_ctl_feat_report */
        CHARACTERISTIC_UUID16_WRITABLE (HDLC_HIDS_VOICE_CTL_FEAT_REPORT, HDLC_HIDS_VOICE_CTL_FEAT_REPORT_VALUE, __UUID_CHARACTERISTIC_REPORT, GATTDB_CHAR_PROP_READ | GATTDB_CHAR_PROP_WRITE, GATTDB_PERM_READABLE | GATTDB_PERM_WRITE_REQ),
            /* Descriptor: Report Reference */
            CHAR_DESCRIPTOR_UUID16 (HDLD_HIDS_VOICE_CTL_FEAT_REPORT_REPORT_REFERENCE, __UUID_DESCRIPTOR_REPORT_REFERENCE, GATTDB_PERM_READABLE),
...
uint8_t app_gap_peripheral_preferred_connection_parameters[] = {0x06, 0x00, 0x06, 0x00, 0x00, 0x00, 0xE8, 0x03, };
...
uint8_t app_hids_voice_ctl_feat_report[]                     = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, };
...
gatt_db_lookup_table_t app_gatt_db_ext_attr_tbl[] =
{
    ...
    { HDLC_HIDS_VOICE_IN_REPORT_VALUE,                     89,     89,     app_hids_voice_in_report },
    { HDLD_HIDS_VOICE_IN_REPORT_CLIENT_CHAR_CONFIG,        2,      2,      app_hids_voice_in_report_client_char_config },
    { HDLD_HIDS_VOICE_IN_REPORT_REPORT_REFERENCE,          2,      2,      app_hids_voice_in_report_report_reference },
    { HDLC_HIDS_VOICE_CTL_IN_REPORT_VALUE,                 11,     11,     app_hids_voice_ctl_in_report },
    { HDLD_HIDS_VOICE_CTL_IN_REPORT_CLIENT_CHAR_CONFIG,    2,      2,      app_hids_voice_ctl_in_report_client_char_config },
    { HDLD_HIDS_VOICE_CTL_IN_REPORT_REPORT_REFERENCE,      2,      2,      app_hids_voice_ctl_in_report_report_reference },
    { HDLC_HIDS_VOICE_CTL_FEAT_REPORT_VALUE,               11,     11,     app_hids_voice_ctl_feat_report },
    { HDLD_HIDS_VOICE_CTL_FEAT_REPORT_REPORT_REFERENCE,    2,      2,      app_hids_voice_ctl_feat_report_report_reference },
    { HDLC_HIDS_REPORT_MAP_VALUE,                          115,    115,    app_hids_report_map },
...
const uint16_t app_hids_voice_in_report_client_char_config_len = (sizeof(app_hids_voice_in_report_client_char_config));
const uint16_t app_hids_voice_in_report_report_reference_len = (sizeof(app_hids_voice_in_report_report_reference));
const uint16_t app_hids_voice_ctl_in_report_len = (sizeof(app_hids_voice_ctl_in_report));
const uint16_t app_hids_voice_ctl_in_report_client_char_config_len = (sizeof(app_hids_voice_ctl_in_report_client_char_config));
const uint16_t app_hids_voice_ctl_in_report_report_reference_len = (sizeof(app_hids_voice_ctl_in_report_report_reference));
const uint16_t app_hids_voice_ctl_feat_report_len = (sizeof(app_hids_voice_ctl_feat_report));
const uint16_t app_hids_voice_ctl_feat_report_report_reference_len = (sizeof(app_hids_voice_ctl_feat_report_report_reference));
