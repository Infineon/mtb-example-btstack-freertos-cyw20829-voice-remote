...
#define CY_CFG_SYSCLK_CLKHF3_DIVIDER CY_SYSCLK_CLKHF_DIVIDE_BY_4
...
#define CY_CFG_SYSCLK_CLKMF_ENABLED 1
#define CY_CFG_SYSCLK_CLKMF_FREQ 2000000UL
#define CY_CFG_SYSCLK_CLKMF_DIVIDER 1UL
...
__STATIC_INLINE void Cy_SysClk_ClkHf3Init()
{
    ...
    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF3, CY_SYSCLK_CLKHF_DIVIDE_BY_4);
...
__STATIC_INLINE void Cy_SysClk_ClkMfInit()
{
