                         ...
                         wiced_bt_gatt_event_data_t *p_event_data)
{
    ...
    case GATT_ATTRIBUTE_REQUEST_EVT:
        ...
        gatt_status = app_gatt_attr_request_cb(p_attr_req, &error_handle);
...
app_gatt_connection_status_change_cb(wiced_bt_gatt_connection_status_t *p_conn_status)
{
    ...
    wiced_bt_ble_pref_conn_params_t conn_param_t = {
        .conn_interval_min        = MIN_CI,
        .conn_interval_max        = MAX_CI,
        .conn_latency             = 6,
        .conn_supervision_timeout = SUPERVISION_TO,
        .min_ce_length            = 0,
        .max_ce_length            = 0,
    };
    ...
    if ((p_conn_status->connected) && (0 == app_bt_conn_id))
    {
        ...
        if (0 != wiced_bt_l2cap_update_ble_conn_params(peer_bd_addr, &conn_param_t))
        {
