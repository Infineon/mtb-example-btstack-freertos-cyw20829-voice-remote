/******************************************************************************
* File Name:   cy_encoder.h
*
* Description: This file includes function declaration of Encoder which are
* used by Audio Module to compress and encode the audio data
*
